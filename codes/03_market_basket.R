...
load('C:/Users/suppy/Desktop/online-retail-data-analysis-master/intermediate-data/retail_cleaned.RData')
...
write.csv(transaction_df,'C:/Users/suppy/Desktop/online-retail-data-analysis-master/intermediate-data/transaction_df.csv', row.names = FALSE)
...
write.csv(itemList,'C:/Users/suppy/Desktop/online-retail-data-analysis-master/intermediate-data/market_basket_tr.csv', row.names = FALSE)

#Read the csv in 'basket' format
#rm.duplicates removes duplicate items in a particular transaction.
transaction <- read.transactions('C:/Users/suppy/Desktop/online-retail-data-analysis-master/intermediate-data/market_basket_tr.csv', format = 'basket', quote = "", cols = NULL, sep=',', skip = 1, rm.duplicates = T)
transaction
summary(transaction)
